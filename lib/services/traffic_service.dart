...
import 'package:mapas/models/traffic_response.dart';
import 'package:mapas/services/services.dart';

class TrafficService {
  late final Dio _dioTraffic;
  late final Dio _dioPlaces;
  ...
  Future<TrafficResponse> getCordsStartToEnd(LatLng start, LatLng end) async {
    final coorsString =
        '${start.longitude},${start.latitude};${end.longitude},${end.latitude}';
    final url = '$_baseTrafficUrl/driving/$coorsString';

    final result = await _dioTraffic.get(url);

    final data = TrafficResponse.fromJson(result.data);
    return data;
  }
